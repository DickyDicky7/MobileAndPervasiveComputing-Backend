...
app.get(
  ...
  async (
    ...
    const hub1 = new Hub({
      name: "Hub 1",
      address:
        "Hẻm 196 Lê Thị Bạch Cát, Ho Chi Minh City, Ho Chi Minh 72000, Vietnam",
    });
    const hub2 = new Hub({
      name: "Hub 2",
    ...
    const order1 = new Order({
      ...
      hubId: hub1._id,
      deliveryAddress:
        "Nguyễn Biểu, District 5, Ho Chi Minh City, 73009, Vietnam",
    ...
    const order2 = new Order({
      ...
      hubId: hub1._id,
      deliveryAddress:
        "Đặng Trần Côn, District 1, Ho Chi Minh City, 71009, Vietnam",
      message: "-",
      inProgress: false,
    });
    await order1.save();
    ...
    await staff2.save();
    res.status(200).json({
      initData: [hub1, hub2, order1, order2, staff1, staff2],
    });
  }
);
...
const supabase = createClient(
  "https://qwkgxxjxdccicszuldkm.supabase.co",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF3a2d4eGp4ZGNjaWNzenVsZGttIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjAyMDIwMjUsImV4cCI6MjAzNTc3ODAyNX0.UyBn7T4RUaZk4Fl6xBfbwOgzXqPKYDJ23azeGd3_E6U"
);
